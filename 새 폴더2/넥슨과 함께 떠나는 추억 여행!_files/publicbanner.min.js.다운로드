...
$jscomp.polyfill("String.prototype.startsWith",function(b){return b?b:function(b,e){var d=$jscomp.checkStringArgs(this,b,"startsWith");b+="";for(var k=d.length,u=b.length,r=Math.max(0,Math.min(e|0,d.length)),m=0;m<u&&r<k;)if(d[r++]!=b[m++])return!1;return m>=u}},"es6","es3");$jscomp.owns=function(b,d){return Object.prototype.hasOwnProperty.call(b,d)};
...
contentsIdx:h,contentsType:f}),timeout:2E3,xhrFields:{withCredentials:!0},crossDomain:!0,success:function(){},fail:function(){},error:function(){},complete:function(){}}):console.warn("0 or null values \u200b\u200bare excluded from cem statistics.")}function k(){try{return b.self!==b.top}catch(a){return!0}}function u(a,c,h){k()||g(v+"//"+t.GNBAPI+"/banners/nexon-common-banners/statistics/impressions",a,c,h)}function r(a,c,h){k()||g(v+"//"+t.GNBAPI+"/banners/nexon-common-banners/statistics/clicks",
a,c,h)}function m(a,c,h){"object"==typeof $h&&"object"==typeof $h.a2s&&"function"==typeof m&&$h.a2s.sendClickLog(a,c,h)}function B(a,c){"object"==typeof $h&&"object"==typeof $h.a2s&&"function"==typeof m&&$h.a2s.sendContentsLog(a,c)}var v="file:"===d.location.protocol?"http:":d.location.protocol,t={RESOURCE:"rs.nxfs.nexon.com",GNBAPI:"gnbapi.nexon.com"};if("undefined"!==typeof b&&!b._sendCEMIframeClickEvent)try{b.addEventListener("message",function(a){b._sendCEMIframeClickEvent(a)},!1)}catch(a){console.error(a)}b._sendCEMIframeClickEvent=
function(a){a&&a.data&&"cem_statistics_click"===a.data.type&&r(a.data.serviceId,a.data.contentsIdx,a.data.contentsType)};e.prototype={constructor:e,init:function(){this.isPublicBanner=this.getIsPublicBanner();this.gameCode=this.getGameCode();this.mainResourceType={Image:1,Video:2,LiveStream:3,Iframe:4};this.domain={gnbapi:v+"//"+t.GNBAPI,resource:""+t.RESOURCE};this.getPublicPopupBanner()},getIsPublicBanner:function(){return"true"==this.script.getAttribute("data-ispublicbanner").toLowerCase()?!0:
!1},getGameCode:function(){var a=this.script.getAttribute("data-gamecode");return a?a:65533},getYouTubeID:function(a){var c=a.lastIndexOf("/")+1;a=a.substring(c);a.startsWith("watch")&&(a=a.replace("watch?v=",""));c=a.indexOf("?");-1<c&&(a=a.substring(0,c));return a},getYouTubeOpts:function(a){var c={};try{var h=a.indexOf("?");a.substring(h+1).split("&").forEach(function(a){var h=a.indexOf("="),b=a.substring(0,h);a=a.substring(h+1);isNaN(Number(a))||(a=Number(a));h={};c=Object.assign(c,(h[b]=a,h))})}catch(f){"undefined"!==
typeof b.console&&console.warn(f)}return c},setCookie:function(a,c,h){var b=new Date;b=new Date(b.getFullYear(),b.getMonth(),b.getDate(),23,59,59,999);d.cookie=0>=h?a+"="+escape(c)+"; path=/; domain=nexon.com;":a+"="+escape(c)+"; path=/; domain=nexon.com; expires="+b.toGMTString()+";"},getCookie:function(a){a+="=";for(var c=0;c<=d.cookie.length;){var b=c+a.length;if(d.cookie.substring(c,b)==a)return-1==(endOfCookie=d.cookie.indexOf(";",b))&&(endOfCookie=d.cookie.length),unescape(d.cookie.substring(b,
...
g=c.contentsIdx,k=c.contentsType,t=c.bannerSN;b=c.resourceURL;var l=c.resourceType;f=c.landingURL;var n=a.getLogAttribute(t,b),p=a.getA2sLog(t,b);c=l===a.mainResourceType.Image?!1:l===a.mainResourceType.LiveStream?Helper.isIE()&&10>=Helper.isIE():l===a.mainResourceType.Video&&Helper.isIE()&&9>=Helper.isIE();var x="",q="",v="",y="",z="";q="A";var A=" ";b=decodeURIComponent(b);f=decodeURIComponent(f);l===a.mainResourceType.Iframe&&0<b.indexOf("cem.nexon.com")&&(q="B",A=" gnbFullBannerSizeB ");l===a.mainResourceType.Image?
...
v+"\n                                "+y+"\n                                "+z+"\n                            <div>\n                        </div>\n                    </div></div>";try{var w=$nq(".gnbWrapper");w.append(f)}catch(C){w=d.querySelector(".gnbWrapper"),w.innerHTML+=f}l===a.mainResourceType.Image?($nq("#gnbFullBannerImage").click(function(){m("P_BANNER",p.mainpopup_img);r(e,g,k)}),B("P_BANNER",p.mainpopup_img),u(e,g,k)):l===a.mainResourceType.Iframe?($nq("#gnbFullBannerImage").click(function(){m("P_BANNER",
p.mainpopup_iframe_body);r(e,g,k)}),B("P_BANNER",p.mainpopup_iframe_body),u(e,g,k)):($nq(".gnbFullBannerBtDetail").click(function(){m("P_BANNER",p.mainpopup_video_more);r(e,g,k)}),B("P_BANNER",p.mainpopup_video_more),u(e,g,k),c||(w=a.getYouTubeID(b),b=a.getYouTubeOpts(b),a.youtubePlayerAPILoaded=a.isYoutubeIframeAPILoaded(),a.youtubePlayerAPILoaded||a.loadYoutubeIframeApi(),a.registerPlayerCallback(w,b)));$nq(".gnbFullBannerDimmed").on("click",function(){$nq(".gnbFullBanner").remove();a.removeEventHandlers();
l===a.mainResourceType.Video||l===a.mainResourceType.LiveStream?m("P_BANNER",p.mainpopup_video_dim):l===a.mainResourceType.Image?m("P_BANNER",p.mainpopup_img_dim):m("P_BANNER",p.mainpopup_iframe_dim);r(e,g,k)});$nq(".gnbFullBannerBtClose").on("click",function(){$nq(".gnbFullBanner").remove();a.removeEventHandlers();l===a.mainResourceType.Video||l===a.mainResourceType.LiveStream?m("P_BANNER",p.mainpopup_video_close):l===a.mainResourceType.Image?m("P_BANNER",p.mainpopup_img_close):m("P_BANNER",p.mainpopup_iframe_close)});
$nq(".gnbFullBannerBtToday").on("click",function(){$nq(".gnbFullBanner").remove();a.removeEventHandlers();a.setCookie("hideBanner"+t,!0,1);l===a.mainResourceType.Video||l===a.mainResourceType.LiveStream?m("P_BANNER",p.mainpopup_video_today):l===a.mainResourceType.Image?m("P_BANNER",p.mainpopup_img_today):m("P_BANNER",p.mainpopup_iframe_today)})}},fail:function(){},error:function(a,b,d){},complete:function(a,b){}})}},resizeBannerIFrame:function(a){600>a&&(a=600);750<a&&(a=750);if(750>a)try{var b=a+
